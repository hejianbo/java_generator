...
class DalConfig(BaseConfig):
    def __init__(self, config):
        ...
        self.dao_package = self.base_package + config.get("template_dal", "dao_package")
        self.mapper_package = self.base_package + config.get("template_dal", "mapper_package")
        self.entity_package = self.base_package + config.get("template_dal", "entity_package")
